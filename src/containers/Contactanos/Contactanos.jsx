        ...
        <form id="formTransform">
          <fieldset>
            <legend>
              ...
              <select className="input__size" style="height: 27px" name=" Autos">
              ...
              <input style="height: 27px" type="checkbox" name="aceptar" value="1" />

              <br />
              <input style="height: 27px" className="btn btn-light" type="submit" value="Enviar" />
              <input style="height: 27px" className="btn btn-light" type="reset" value="Limpiar" />
